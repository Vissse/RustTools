...
const CALCULATORS = [
  {
    ...
    description: "Calculate exactly how much sulfur and explosives you need to raid a base.",
    path: "/raid",
    status: "published"
  },
  {
    id: "recycling",
    title: "Recycling",
    description: "Find out how much scrap and resources you will get from recycling items.",
    path: "/recycling",
    status: "published"
  },
  {
    id: "furnace",
    title: "Furnace",
    description: "Calculate wood and time required to smelt ores in different furnaces.",
    path: "/furnace",
    status: "published"
  },
  {
    id: "genetics",
    title: "Genetics",
    description: "Determine the exact crossbreeding results for your perfect plant clones.",
    path: "/genetics",
    status: "published"
  },
  {
  ...
  },
  {
    id: "decay",
    title: "Decay",
    description: "Calculate how long it takes for different building blocks to decay.",
    path: "/decay",
    status: "published"
  },
  {
  ...
  },
  {
    id: "salvaging",
    title: "Salvaging",
    description: "Calculate resources gained from salvaging various components.",
    path: "/salvaging",
    status: "published"
  }
];
...
function CalcCard({ calc, index }: { calc: typeof CALCULATORS[0]; index: number }) {
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1">
        <div className="mb-4 flex justify-between items-start">
          <h3 className="text-2xl font-bold text-text-bright tracking-wide font-display uppercase leading-tight">{calc.title}</h3>
          {!isPublished && (
  ...
  if (isPublished) {
    return <Link to={calc.path} className="block h-full">{content}</Link>;
  }
